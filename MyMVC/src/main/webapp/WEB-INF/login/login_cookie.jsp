		...
		if(cookies != "") {
			...
			for(let i=0; i<arrCookie.length; i++) {
				...
				if(cookie_name == "saveid") {
					const cookie_val = arrCookie[i].substring(arrCookie[i].indexOf("=")+1);
					$("input#loginUserid").val(cookie_val);
					$("input#checkbox[name='saveid']").prop("checked", true);
					break;
				}//end of if(cookie_name == "saveid")-----
